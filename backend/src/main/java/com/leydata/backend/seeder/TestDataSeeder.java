...
import com.leydata.backend.repository.*;
...
/**
 * Pobla la BD con datos realistas de prueba para "MedVida SpA" (empresa de salud complementaria).
...
public class TestDataSeeder implements CommandLineRunner {
    ...
    private List<LegalBasisCatalog> seedLegalBasis() {
        ...
        art12c.setDescription("Art. 12 Ley 21.719 — tratamiento basado en consentimiento libre, informado y específico del titular.");
        ...
        art12k.setDescription("Art. 12 Ley 21.719 — necesario para la ejecución de un contrato del que el titular es parte.");
        ...
        art13.setDescription("Art. 13 Ley 21.719 — consentimiento explícito requerido para salud, biométricos u origen racial.");
        ...
        art16.setDescription("Art. 16 Ley 21.719 — cesión de datos a terceros con consentimiento o interés legítimo acreditado.");
    ...
    private List<PurposeRequests> seedPurposeRequests(List<Users> users, List<Domains> domains) {
        ...
        approved.setJustification("Se requiere enviar campañas de vacunación y control preventivo a afiliados activos con consentimiento.");
        ...
        pending.setJustification("Análisis estadístico interno para ajuste de prima basado en datos anonimizados de siniestros.");
        ...
        rejected.setReviewNotes("Rechazada: incluye DATOS_SALUD sin base legal ART_13 explícita. Reenviar con justificación del Art. 13.");
    ...
    private List<PurposeDataCategories> seedPurposeDataCategories(List<Purposes> purposes,
        ...
        // cats: 0=EMAIL, 1=NOMBRE_COMPLETO, 2=RUT, 3=TELEFONO, 4=DATOS_SALUD, 5=DATOS_FINANCIEROS
    ...
    private List<Templates> seedTemplates() {
        ...
        web.setDescription("Plantilla principal para el centro de preferencias web de MedVida. Incluye todos los propósitos activos.");
        web.setVersion(1);
        ...
        app.setDescription("Plantilla compacta para la app móvil MedVida. Solo propósitos esenciales y de mejora de servicio.");
        app.setVersion(1);
