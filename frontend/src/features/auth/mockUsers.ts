...
export const MOCK_USERS: AppUser[] = [
  // Usuarios internos (referencia local — auth real va por Keycloak)
  { id: 'u1', name: 'Ana Torres',           email: 'ana@leydata.cl',       role: 'ADMIN',        area: null },
  { id: 'u2', name: 'Carlos Ruiz',          email: 'carlos@leydata.cl',    role: 'DPO',          area: null },
  { id: 'u3', name: 'María López',          email: 'maria@leydata.cl',     role: 'JEFE_DOMINIO', area: 'Recursos Humanos' },
  { id: 'u4', name: 'Pedro Soto',           email: 'pedro@leydata.cl',     role: 'JEFE_DOMINIO', area: 'Marketing' },
  { id: 'u5', name: 'Lucía Vargas',         email: 'lucia@leydata.cl',     role: 'JEFE_DOMINIO', area: 'Tecnología' },
