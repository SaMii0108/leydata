...
export const getPurposes = async (token?: string | null): Promise<PurposeResponse[]> => {
  return request<PurposeResponse[]>('/api/purposes', {}, token);
};

export const getPurpose = async (id: string, token?: string | null): Promise<PurposeResponse> => {
  return request<PurposeResponse>(`/api/purposes/${id}`, {}, token);
};
...
export const getPurposesByDomain = async (
  ...
  return request<PurposeResponse[]>(`/api/purposes/domain/${domainId}`, {}, token);
};
...
export const createPurpose = async (
  ...
  return request<PurposeResponse>(
    '/api/purposes',
...
export const deactivatePurpose = async (
  ...
  return request<PurposeResponse>(`/api/purposes/${id}`, { method: 'DELETE' }, token);
};
